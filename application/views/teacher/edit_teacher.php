                            ...
                            echo $error;
                                ...
                                <?php if(isset($teacher->teacher_image) && $teacher->teacher_image!=""){ ?>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <input type="text" readonly class="form-control" id="teacher_username" name="teacher_username" value="<?php echo $teacher->username;  ?>"/>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <label for="teacher_username">Teacher Password </label>


                                        <input type="text" minlength="6" class="form-control" id="teacher_password" name="teacher_password" value="" placeholder="Enter new password to change"/>
                                ...
                                <div class="box container">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <p style="border-bottom: 1px solid black;"><strong>Class Allotment</strong> (Please Fill * all Required Field)</p>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <h6>Please select all  standards and click add</h6>
                                            ...
                                            <div class="form-control">
                                                ...
                                                <select id="standard">
                                                    ...
                                                    <?php foreach ($standards as $row) { ?>
                                                        ...
                                                        <option value="<?php echo $row->standard_title; ?>" ><?php echo $row->standard_title; ?></option>
                                            ...
                                            <button id="adder" onclick="return false;">Add Standard</button>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <h4>Standrads:</h4><h5>Click on Any standard to remove it</h5><br />


                                            <div class="container" id="combs">
                                        ...
                                        <input value="" id="combinations" name="combinations" hidden="hidden" style="display: :none;">
...
<script src="<?php echo base_url($this->config->item("theme_admin")."/plugins/ckeditor/ckeditor.js"); ?>"></script>
    ...
    <script>
        ...
        window.initval="<?php echo $teacher->teaching; ?>";
        ...
        $("#adder").click(function () {
            ...
            a="<div class='comb_elem' onclick='re(this)' id='com"+window.combc.toString()+"'>"+st.toString()+"</div>";
...
window.addEventListener("load",function (ev) {
    ...
    window.initval.split(";").forEach(function (value) {
