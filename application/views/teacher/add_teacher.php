  ...
  <body class="hold-transition skin-blue sidebar-mini">
                                    ...
                                    <div class="col-md-6">
                                     ...
                                     <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" class="form-control" id="teacher_username" name="teacher_username" value="<?php if(isset($_REQUEST["teacher_username"])){echo $_REQUEST["teacher_username"]; } ?>"/>
                                        </div>
                                        <div class="col-md-6">
                                            <label for="teacher_password">Teacher Password </label>
                                            <input type="password" class="form-control" id="teacher_password" name="teacher_password" value="<?php if(isset($_REQUEST["teacher_password"])){echo $_REQUEST["teacher_password"]; } ?>"/>
                                        </div>
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <h4>Standards:</h4><h5>Click on any standard to remove it</h5><br />
    ...
    <script>
        ...
        $("#adder").click(function () {
            st=$("#standard").val();
            sb=$("#subject").val();
            a="<div class='inline comb_elem' onclick='re(this)' id='com"+window.combc.toString()+"'>"+st.toString()+"</div>";
            $("#combs")[0].innerHTML+=a;
            ref();
            window.combc+=1;
        });
